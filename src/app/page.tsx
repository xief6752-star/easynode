...
export default function Home() {
  ...
  return (
    <main className="site-shell">
      ...
      <section className="home-articles" id="wiki-preview"><div className="section-heading"><div><p className="eyebrow">THE FIELD GUIDE</p><h2>机场百科</h2></div><Link className="text-link" href="/wiki">进入百科 ↗</Link></div><div className="home-article-grid"><Link href="/wiki/vpn-test-methodology"><span>01 / 测速方法</span><strong>机场 VPN 怎么测才不容易被单次速度误导？</strong><small>固定条件、连续采样和 7 天趋势。</small></Link><Link href="/wiki/iepl-iplc-dedicated-line"><span>02 / 线路类型</span><strong>IEPL 和 IPLC 专线有什么区别？</strong><small>看懂专线、中转和晚高峰表现。</small></Link><Link href="/wiki/monthly-vs-yearly-plan"><span>03 / 套餐选择</span><strong>机场套餐选月付还是年付？</strong><small>比较价格、周期和预付风险。</small></Link></div></section>
