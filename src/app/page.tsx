...
export default function Home() {
  ...
  return (
    <main className="site-shell">
      ...
      <section className="home-articles" id="articles"><div className="section-heading"><div><p className="eyebrow">THE NOTEBOOK</p><h2>测试文章</h2></div><a className="text-link" href="/wiki">进入机场百科 ↗</a></div><div className="home-article-grid"><a href="/wiki/vpn-test-methodology"><span>01 / 测速方法</span><strong>机场 VPN 怎么测才不容易被单次速度误导？</strong><small>多地区、多时段与 7 天趋势的测试方法。</small></a><a href="/wiki/latency-and-jitter"><span>02 / 运营商观察</span><strong>移动、联通、电信的机场线路表现有什么差异？</strong><small>理解同一节点在不同网络下的变化。</small></a><a href="/wiki/peak-hour-testing"><span>03 / 选购指南</span><strong>晚高峰选机场，应该重点看哪些数据？</strong><small>从延迟增幅、速度下降和断线记录判断。</small></a></div></section>
