...
const airports = {
  shunyun: { name: "瞬云", english: "SHUNYUN", price: "¥16 起/月", route: "中转 + 专线", rating: "B+", score: 86, latency: 110, speed: "198", color: "coral", summary: "中转与专线结合的日常型机场，本页按当前阶段测试样本展示约 200 Mbps 下载速度。", goodFor: "日常浏览、高清视频和希望兼顾线路选择的用户", watch: "当前评分和指标属于阶段性展示结果，仍需持续导入更多独立样本。", link: "" },
  huanyuyun: { name: "寰宇云", english: "HUANYUYUN", price: "¥14 起/月", route: "IPLC 专线", rating: "A", score: 92, latency: 112, speed: "210", color: "teal", summary: "以 IPLC 专线为主要卖点的机场，本页按当前阶段测试样本展示约 200 Mbps 下载速度。", goodFor: "重视晚高峰稳定性、视频流媒体和跨境服务访问的用户", watch: "专线表现需要按地区、运营商和具体节点分别验证，当前评级不等于完整长期评分。", link: "" },
  jindouyun: { name: "筋斗云", english: "JINDOUYUN", price: "¥16 起/月", route: "IEPL / IPLC 专线", rating: "A", score: 92, latency: 114, speed: "205", color: "yellow", summary: "以 IEPL/IPLC 优化线路为特色，本页按当前阶段测试样本展示约 200 Mbps 下载速度。", goodFor: "视频会议、流媒体和对高峰期线路有要求的用户", watch: "专线节点的真实表现会随入口、运营商和使用时间变化，建议先月付验证。", link: "" },
  jiuyun: { name: "九云", english: "JIUYUN", price: "¥6 起/月", route: "VLESS 海外中转", rating: "B+", score: 86, latency: 116, speed: "192", color: "blue", summary: "价格门槛较低的海外中转方案，本页按当前阶段测试样本展示约 200 Mbps 下载速度。", goodFor: "预算有限、需要低成本备用线路或轻量日常使用的用户", watch: "低价方案更需要关注长期稳定性、流量规则、退款政策和运营持续性。", link: "" },
  baoyun: { name: "宝云", english: "BAOYUN", price: "¥4 起/月", route: "VLESS 海外中转", rating: "B+", score: 86, latency: 45, speed: "280", color: "green", summary: "面向轻量使用的海外 VLESS 中转方案，本页按本地评测资料展示约 280 Mbps 下载速度。", goodFor: "预算有限、日常浏览和需要备用线路的用户", watch: "低价中转方案的晚高峰表现、流量规则和长期运营情况仍需持续观察。", link: "https://宝云.com" },
  speedworld: { name: "速界", english: "SPEEDWORLD", price: "¥6 起/月", route: "IEPL 专线", rating: "A-", score: 91, latency: 12, speed: "700+", color: "purple", summary: "采用 IEPL 专线与企业级加密方案，本页按本地评测资料展示晚高峰约 700 Mbps 下载速度。", goodFor: "重视晚高峰速度、办公连接和专线稳定性的用户", watch: "专线名称和峰值带宽来自公开评测资料，仍需结合自己的地区和运营商复测。", link: "" },
  jilianyun: { name: "极连云", english: "JILIANYUN", price: "¥18 起/月", route: "全 IPLC 专线", rating: "A", score: 92, latency: 20, speed: "600+", color: "violet", summary: "以全 IPLC 专线和原生 IP 解锁为特色，本页按本地评测资料展示晚高峰约 600 Mbps 下载速度。", goodFor: "需要稳定专线、流媒体解锁和晚高峰持续性的用户", watch: "原生 IP 与专线表现会随节点和时间变化，建议先按月验证实际体验。", link: "" },
