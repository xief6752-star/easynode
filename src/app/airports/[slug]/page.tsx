...
const airports = {
  ...
  baoyun: { name: "宝云", english: "BAOYUN", price: "¥4 起/月", route: "VLESS 海外中转", rating: "B+", score: 86, latency: 45, speed: "280", color: "green", summary: "面向轻量使用的海外 VLESS 中转方案，本页按本地评测资料展示约 280 Mbps 下载速度。", goodFor: "预算有限、日常浏览和需要备用线路的用户", watch: "低价中转方案的晚高峰表现、流量规则和长期运营情况仍需持续观察。" },
  speedworld: { name: "速界", english: "SPEEDWORLD", price: "¥6 起/月", route: "IEPL 专线", rating: "A-", score: 91, latency: 12, speed: "700+", color: "purple", summary: "采用 IEPL 专线与企业级加密方案，本页按本地评测资料展示晚高峰约 700 Mbps 下载速度。", goodFor: "重视晚高峰速度、办公连接和专线稳定性的用户", watch: "专线名称和峰值带宽来自公开评测资料，仍需结合自己的地区和运营商复测。" },
  jilianyun: { name: "极连云", english: "JILIANYUN", price: "¥18 起/月", route: "全 IPLC 专线", rating: "A", score: 92, latency: 20, speed: "600+", color: "violet", summary: "以全 IPLC 专线和原生 IP 解锁为特色，本页按本地评测资料展示晚高峰约 600 Mbps 下载速度。", goodFor: "需要稳定专线、流媒体解锁和晚高峰持续性的用户", watch: "原生 IP 与专线表现会随节点和时间变化，建议先按月验证实际体验。" },
  miaomiaoyun: { name: "秒秒云", english: "MIAOMIAOYUN", price: "¥14 起/月", route: "VLESS 海外中转", rating: "B", score: 82, latency: 26, speed: "300+", color: "pink", summary: "面向日常使用的海外中转方案，本页按本地评测资料展示晚高峰约 300 Mbps 下载速度。", goodFor: "需要常规流媒体、网页浏览和中等流量套餐的用户", watch: "中转线路晚高峰可能存在波动，购买前应确认流量、退款和节点规则。" },
  shanshuiyun: { name: "山水云", english: "SHANSHUIYUN", price: "¥15 起/月", route: "优质中转", rating: "B+", score: 84, latency: 24, speed: "320+", color: "green", summary: "以优质中转和不限时套餐为卖点，本页按本地评测资料展示晚高峰约 320 Mbps 下载速度。", goodFor: "希望灵活使用、偶尔备用并关注套餐周期的用户", watch: "不限时套餐的实际价值取决于流量和节点限制，购买前请核对当前条款。" },
  jinyun: { name: "锦云", english: "JINYUN", price: "¥6 起/月", route: "海外中转", rating: "B", score: 81, latency: 30, speed: "260+", color: "pink", summary: "主打小流量与低价套餐的海外中转服务，本页按本地评测资料展示晚高峰约 260 Mbps 下载速度。", goodFor: "轻度使用、预算有限或需要备用机场的用户", watch: "低价小流量套餐要重点确认额度、重置周期和超额规则。" },
  liyun: { name: "鲤云", english: "LIYUN", price: "¥7 起/月", route: "海外中转", rating: "B", score: 82, latency: 28, speed: "280+", color: "teal", summary: "提供小流量灵活套餐的海外中转服务，本页按本地评测资料展示晚高峰约 280 Mbps 下载速度。", goodFor: "轻量浏览、备用线路和想控制月度开支的用户", watch: "小流量套餐适合按需使用，长期订阅前请确认套餐有效期和流量规则。" },
  cailuyun: { name: "财路云", english: "CAILUYUN", price: "¥7 起/月", route: "按需计费中转", rating: "B", score: 81, latency: 29, speed: "270+", color: "yellow", summary: "主打按需计费与小流量套餐，本页按本地评测资料展示晚高峰约 270 Mbps 下载速度。", goodFor: "轻度用户、临时备用和希望按实际用量付费的用户", watch: "按需计费方案需要关注流量价格、有效期和长期运营情况。" },
} as const;
