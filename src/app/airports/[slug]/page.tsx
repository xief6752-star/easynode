...
const airports = {
  ...
  kunpeng: { name: "鲲鹏加速", english: "KUNPENG", price: "¥1 起/月", route: "全速专线", rating: "B+", score: 88, latency: 35, speed: "500+", color: "orange", summary: "1 元试用套餐机场，全速专线不限速，本页按本地评测资料展示约 500 Mbps 下载速度。", goodFor: "预算有限、想先体验再决定，或需要低成本备用线路的用户", watch: "1 元套餐提供 1GB 流量试用，1.0 倍率无陷阱，支持 Netflix 和 ChatGPT 解锁。", link: "https://kunpengjiasu.com/#/register?code=tQvtkYsB" },
} as const;
